...
public class TravelTimeConfig {
	...
	public final String motorwayName;
	public final String forwardName;
	public final String backwardName;
	public final String forwardSegmentIdPrefix;
	public final String backwardSegmentIdPrefix;
	public final String preferencesFileName;
	public final String remoteJsonUrl;
	public final String localJsonFileName;
	 ...
	 *            'remoteJsonUrl'.
	 */
	public TravelTimeConfig(String motorwayName, String forwardName,
			String backgwardName, String forwardSegmentIdPrefix,
			String backwardSegmentIdPrefix, String preferencesFileName,
			String remoteJsonUrl, String localJsonFileName) {
		this.motorwayName = motorwayName;
		this.forwardName = forwardName;
		this.backwardName = backgwardName;
		this.forwardSegmentIdPrefix = forwardSegmentIdPrefix;
		this.backwardSegmentIdPrefix = backwardSegmentIdPrefix;
		this.preferencesFileName = preferencesFileName;
		this.remoteJsonUrl = remoteJsonUrl;
		this.localJsonFileName = localJsonFileName;
	}
}
